...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      const skillsCSV = profile.skills.join(','); //Bring skills array back to CSV
      ...
      socialInputs = (
        <div>
          ...
          <InputGroup
            ...
            name="instagram"
            icon="fab fa-instagram rounded-0"
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              <Link to="/dashboard" className="btn btn-light rounded-0">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <div className="mb-3">
                  <button
                    ...
                    className="btn btn btn-outline-secondary rounded-0"
                  >
